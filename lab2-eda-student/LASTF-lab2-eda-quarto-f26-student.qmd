...
Sam walks along the same two mile stretch of beach each morning walking his dog. While he walks, he picks up any trash he encounters. For the last ninety days, he has been keeping track of the number of pieces of trash he picks up each day. Load in the dataset `trash.csv`. The variable inside is `items`. 
...
What is the variable of interest recorded in `items` and its type (categorical nominal, etc.)?  
...
What percentage of Sams's walks did he pick up at least 18 pieces of trash? 
...
Do more walks have 15 or less pieces of trash collected compared to those with at or above 15? Explain your answer.   
...
Look at the graphic you created in 3,4. What information do you learn about the trash collected on Sam's walks? How do your measures of center agree with the information you learned from the graphic?
